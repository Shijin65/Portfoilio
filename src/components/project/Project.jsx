...
const projectList = [
  {
    proImgUrl:`${projectimage}`,
    proName:"Promptopia",
    proDes:`GoEat is a food ordering application designed to streamline the process of ordering food online. With its friendly user interface and robust features, GoEat offers a seamless experience for both customers and restaurants.`,
    proGithub:'https://github.com/Shijin65/GoEat',
    proLiveDemo:'https://goeat.netlify.app/'
  },
  {
    proImgUrl:`${projectimage2}`,
    proName:"Emoji Memory Game (IOS)",
    proDes:` Movie Hub is a dynamic platform meticulously crafted to provide detailed insights into various movies, seamlessly integrating YouTube videos related to each film`,
    proGithub:'https://github.com/Shijin65/Movie_HuB',
    proLiveDemo:'https://moviehub-sjn.netlify.app/',
