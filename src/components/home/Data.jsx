...
import resume from "../../assets/SHIJIN P resume.pdf"
...
const Data = () => {
  return (
    <div className="home__data">
        ...
        I am a self-taught full stack web developer with experience in developing user-friendly and responsive web applications. Committed to continuous learning to keep up with the latest trends in the industry.        </p>
