                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                                    {stats.map((stat, index) => (
                                        <motion.div
                                            ...
                                            className="text-center p-4 rounded-2xl bg-slate-800/30 border border-slate-700/30 hover:border-blue-500/30 transition-colors"
                                        >
                                            <stat.icon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 mx-auto mb-2" />
